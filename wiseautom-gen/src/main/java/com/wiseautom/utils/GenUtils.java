...
import com.wiseautom.entity.Column;
import com.wiseautom.entity.Table;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                String zipString = getFileName(template, tableEntity.getClassName(), config.getString("package"));
                //添加到zip
                zip.putNextEntry(new ZipEntry(null == zipString ? "" : zipString));
    ...
    private static String getFileName(String template, String className, String packageName) {
        ...
        if (template.contains(CommonAttribute.ENTITY_JAVA_VM)) {
            return packagePath + "entity" + File.separator + className + ".java";
        }

        if (template.contains(CommonAttribute.DAO_JAVA_VM)) {
            return packagePath + "dao" + File.separator + className + "Dao.java";
        }

        if (template.contains(CommonAttribute.DAO_XML_VM)) {
            return packagePath + "dao" + File.separator + className + "Dao.xml";
        }

        if (template.contains(CommonAttribute.SERVICE_JAVA_VM)) {
            return packagePath + "service" + File.separator + className + "Service.java";
        }

        if (template.contains(CommonAttribute.SERVICE_IMPL_JAVA_VM)) {
            return packagePath + "service" + File.separator + "impl" + File.separator + className + "ServiceImpl.java";
        }

        if (template.contains(CommonAttribute.CONTROLLER_JAVA_VM)) {
            return packagePath + "controller" + File.separator + className + "Controller.java";
        }

        if (template.contains(CommonAttribute.LIST_JSP_VM)) {
            return "main" + File.separator + CommonAttribute.WEB_APP + File.separator + "page"
                    + File.separator + className.toLowerCase() + File.separator + "list.jsp";
        }
        if (template.contains(CommonAttribute.ADD_JSP_VM)) {
            return "main" + File.separator + CommonAttribute.WEB_APP + File.separator + "page"
                    + File.separator + className.toLowerCase() + File.separator + "add.jsp";
        }
        if (template.contains(CommonAttribute.EDIT_JSP_VM)) {
            return "main" + File.separator + CommonAttribute.WEB_APP + File.separator + "page"
                    + File.separator + className.toLowerCase() + File.separator + "edit.jsp";
        }
        if (template.contains(CommonAttribute.INFO_JSP_VM)) {
            return "main" + File.separator + CommonAttribute.WEB_APP + File.separator + "page"
                    + File.separator + className.toLowerCase() + File.separator + "info.jsp";
        }
        if (template.contains(CommonAttribute.LIST_JS_VM)) {
            return "main" + File.separator + CommonAttribute.WEB_APP + File.separator + "page"
                    + File.separator + className.toLowerCase() + File.separator + "js" + File.separator + "list.js";
        }
        if (template.contains(CommonAttribute.COMMON_JSP_VM)) {
            return "main" + File.separator + CommonAttribute.WEB_APP + File.separator + "page"
                    + File.separator + className.toLowerCase() + File.separator + "common.jsp";
        }
        if (template.contains(CommonAttribute.MENU_SQL_VM)) {
